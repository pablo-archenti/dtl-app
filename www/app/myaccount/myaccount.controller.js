(function() {
    ...
    SignupCtrl.$inject         = ['$scope', '$state', '$ionicHistory', 'dtlVolunteer', 'alert', 'loader', 'goBackState', 'dtlDeviceToken'];
    ...
    function SignupCtrl($scope, $state, $ionicHistory, dtlVolunteer, alert, loader, goBackState, dtlDeviceToken) {
